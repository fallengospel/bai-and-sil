          ...
          {searches.map((search) => (
            ...
            >
              <button
                ...
                className="flex items-center gap-2 text-sm text-gray-700 hover:text-[#1a56db] text-left flex-1 min-w-0"
              >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-white rounded-xl shadow-xl w-full max-w-sm mx-4 p-6">
            ...
            <input
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#1a56db]/20 focus:border-[#1a56db]"
            />
