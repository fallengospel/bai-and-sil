    ...
    <div className="bg-white rounded-xl border border-gray-100 p-5 space-y-3">
      <div className="flex items-center justify-between">
        ...
        <button
          ...
          className="text-xs text-bai-blue hover:underline flex items-center gap-1"
        >
          ...
          {searches.map((search) => (
            ...
            >
              <button
                ...
                className="flex items-center gap-2 text-sm text-gray-700 hover:text-bai-blue text-left flex-1 min-w-0"
              >
              ...
              <button
                ...
                className="p-1 text-gray-400 hover:text-coral opacity-0 group-hover:opacity-100 transition-opacity"
              >
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-white rounded-xl shadow-xl w-full max-w-sm mx-4 p-6">
            ...
            <input
              ...
              className="w-full px-3 py-2 border-2 border-gray-200 rounded-2xl text-sm focus:outline-none focus:ring-2 focus:ring-bai-blue/20 focus:border-bai-blue"
            />
