export function PhoneIllustration({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 120 160" fill="none" className={className} aria-hidden="true">
      ...
      <rect x="20" y="14" width="80" height="128" rx="8" fill="#EAF0FB" />
      {/* Screen content */}
      <rect x="28" y="26" width="64" height="36" rx="4" fill="#0F3D91" />
      ...
      {/* Camera notch */}
      <circle cx="60" cy="10" r="3" fill="#0F3D91" />
    </svg>
  );
}
...
export function SneakerIllustration({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 140 100" fill="none" className={className} aria-hidden="true">
      ...
      {/* Upper */}
      <path d="M25 62 Q20 45 30 30 Q40 18 55 20 L80 22 L100 30 Q120 40 128 55 L90 52 L60 55 L30 58Z" fill="#EAF0FB" />
      {/* Swoosh/stripe */}
      <path d="M40 50 Q60 35 100 42" stroke="#FFC72C" strokeWidth="4" strokeLinecap="round" fill="none" />
      {/* Laces */}
      <line x1="55" y1="24" x2="65" y2="28" stroke="#0F3D91" strokeWidth="1.5" />
      <line x1="60" y1="22" x2="70" y2="26" stroke="#0F3D91" strokeWidth="1.5" />
      <line x1="65" y1="21" x2="75" y2="25" stroke="#0F3D91" strokeWidth="1.5" />
    </svg>
  );
}
...
export function FanIllustration({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 100 120" fill="none" className={className} aria-hidden="true">
      ...
      {/* Head circle */}
      <circle cx="50" cy="45" r="38" fill="#EAF0FB" stroke="#101B3A" strokeWidth="3" />
      {/* Grill lines */}
      ...
      {/* Center */}
      <circle cx="50" cy="45" r="8" fill="#0F3D91" />
...
export function ControllerIllustration({ className = "" }: { className?: string }) {
  return (
    <svg viewBox="0 0 140 80" fill="none" className={className} aria-hidden="true">
      ...
      {/* D-pad left */}
      <rect x="38" y="33" width="12" height="4" rx="1" fill="#0F3D91" />
      <rect x="42" y="29" width="4" height="12" rx="1" fill="#0F3D91" />
      {/* Buttons right */}
      <circle cx="92" cy="32" r="4" fill="#E63B2E" />
      <circle cx="100" cy="38" r="4" fill="#FFC72C" />
      <circle cx="92" cy="44" r="4" fill="#0F3D91" />
      <circle cx="84" cy="38" r="4" fill="#EAF0FB" />
      {/* Sticks */}
      <circle cx="55" cy="50" r="5" fill="#1a2744" stroke="#0F3D91" strokeWidth="1" />
      <circle cx="85" cy="50" r="5" fill="#1a2744" stroke="#0F3D91" strokeWidth="1" />
    </svg>
  );
}
