    ...
    <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
      ...
      <div style="background: #f9fafb; border-radius: 12px; padding: 30px; margin: 20px 0;">
        ...
        <div style="text-align: center; margin: 30px 0;">
          <div style="background: #023E8A; color: white; padding: 18px 0; border-radius: 12px; font-size: 36px; font-weight: 700; letter-spacing: 12px; display: inline-block; min-width: 200px;">
            ${code}
          </div>
        </div>
  ...
  return `
    ...
    <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
      ...
      <div style="background: #f9fafb; border-radius: 12px; padding: 30px; margin: 20px 0;">
        ...
        <div style="text-align: center; margin: 30px 0;">
          <a href="${resetUrl}" style="background: #023E8A; color: white; padding: 14px 32px; border-radius: 8px; text-decoration: none; font-weight: 600; display: inline-block;">
            Reset Password
          </a>
        </div>
